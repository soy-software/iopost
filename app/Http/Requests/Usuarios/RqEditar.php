...
class RqEditar extends FormRequest
{
    ...
    public function rules()
    {
        ...
        switch ($this->input('tipo_identificacion')) {
            case 'Cédula':
                $rg_tipo_identificacion='ecuador:ci|unique:users,identificacion,'.$this->input('usuario');
                break;
            case 'Ruc persona Natural':
                $rg_tipo_identificacion='ecuador:ruc|unique:users,identificacion,'.$this->input('usuario');
                break;
            case 'Ruc Sociedad Pública':
                $rg_tipo_identificacion='ecuador:ruc_spub|unique:users,identificacion,'.$this->input('usuario');
                break;
            case 'Ruc Sociedad Privada':
                $rg_tipo_identificacion='ecuador:ruc_spriv|unique:users,identificacion,'.$this->input('usuario');
                break;
            case 'Pasaporte':
                $rg_tipo_identificacion='unique:users,identificacion,'.$this->input('usuario');
                break;
            case 'Otros':
                $rg_tipo_identificacion='unique:users,identificacion,'.$this->input('usuario');
                break;
